...
pojava_simptoma_za_bolest(adenoidne_vegetacije, glavobolja, 0.12).
pojava_simptoma_za_bolest(adenoidne_vegetacije, hrkanje, 0.33).
pojava_simptoma_za_bolest(adenoidne_vegetacije, zacepljenost_nosa, 0.23).
pojava_simptoma_za_bolest(adenoidne_vegetacije, zapaljenje_srednjeg_uha, 0.03).
pojava_simptoma_za_bolest(adenoidne_vegetacije, apneja, 0.11).
pojava_simptoma_za_bolest(upala_sinusa, glavobolja, 0.15).
pojava_simptoma_za_bolest(upala_sinusa, bol_u_grlu, 0.18).
pojava_simptoma_za_bolest(upala_sinusa, bol_u_uhu, 0.22).
pojava_simptoma_za_bolest(upala_sinusa, bol_u_gornjoj_vilici, 0.26).
pojava_simptoma_za_bolest(upala_sinusa, povisena_temperatura, 0.33).
pojava_simptoma_za_bolest(upala_sinusa, zacepljenost_nosa, 0.09).
